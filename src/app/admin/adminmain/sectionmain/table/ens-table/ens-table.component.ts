...
@Component({
  selector: 'app-ens-table',
  templateUrl: './ens-table.component.html',
  styleUrl: './ens-table.component.css',
  providers: [
    ConfirmationService,
    MessageService
  ]
})
export class EnsTableComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.ensService.getAllEnseignants().subscribe(
      (data)=>{
